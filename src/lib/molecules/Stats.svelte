...
<div class="numbers-flex">
    <div class="numbers-wrapper">
        <div class="children-saved shapes">
            <clipPath id="childern-saved-clip">
                ...
                <div class="stats-numbers nr358"></div>
                <p>Children saved</p>
            </clipPath>
        </div>
            ...
            <div class="talents-discovered shapes">
                <clipPath id="talents-discovered-clip">
                    ...
                    <div class="stats-numbers nr12"></div>
            ...
            <div class="new-partners shapes">
                <clipPath id="new-partners-clip">
                    ...
                    <div class="stats-numbers nr04"></div>
                    <p>New partners</p>
                </clipPath>
            </div>
            ...
            <div class="clubs-invested shapes">
                <clipPath id="clubs-invested-clip">
                    ...
                    <div class="stats-numbers nr08"></div>
                    <p>Clubs invested</p>
                </clipPath>
            </div>
...
<style> 
    ...
    .nr358 {
        ...
        color: var(--justWhite);
        transition: --nr358 5s;
        counter-set: nr358 var(--nr358);
        animation: nr358Animation 2.5s forwards;
    }
    
    .nr358::after {
        content: counter(nr358);
    }
    ...
    .nr12 {
        ...
        color: black;
        transition: --nr12 5s;
        counter-set: nr12 var(--nr12);
        animation: nr12Animation 3s forwards;
    }
    
    .nr12::after {
        content: counter(nr12);
    }
    ...
    .nr04 {
        ...
        color: var(--justWhite);
        transition: --nr04 5s;
        counter-set: nr04 var(--nr04);
        animation: nr04Animation 4s forwards;
    }
    
    .nr04::after {
        content: counter(nr04);
    }
    ...
    .nr08 {
        ...
        color: white;
        transition: --nr08 5s;
        counter-set: nr08 var(--nr08);
        animation: nr08Animation 3.5s forwards;
    }
    
    .nr08::after {
        content: counter(nr08);
    }
