...
var require_standalone = __commonJS({
  "node_modules/prettier/standalone.js"(exports, module) {
    (function(t) {
      ...
      var he = (e, t, r) => (r = e != null ? lu(pu(e)) : {}, rr(t || !e || !e.__esModule ? $e(r, "default", { value: e, enumerable: true }) : r, e)), nr = (e) => rr($e({}, "__esModule", { value: true }), e);
      var Eu = (e, t, r) => {
        if (!t.has(e))
      ...
      var or = Me((gt) => {
        ...
        ur.prototype = { diff: function(t, r) {
          ...
          function p() {
            for (var F = -1 * a; F <= a; F += 2) {
              ...
              if (!h || B && E.newPos < C.newPos ? (m = gu(C), u.pushComponent(m.components, void 0, true)) : (m = E, m.newPos++, u.pushComponent(m.components, true, void 0)), g = u.extractCommon(m, r, t, F), m.newPos + 1 >= s && g + 1 >= D)
      ...
      var yn = Me((Ft) => {
        ...
        function oo(e) {
          if (e) {
            var t;
            return (t = jt) != null || (jt = new mn.default.constructor({ enabled: true, level: 1 })), jt;
          }
          return mn.default;
        }
        var En = false;
        ...
        function gn(e, t, r = {}) {
          let n = (r.highlightCode || r.forceColor) && (0, dn.shouldHighlight)(r), o = oo(r.forceColor), u = io(o), i = (F, m) => n ? F(m) : m, s = e.split(Cn), { start: D, end: a, markerLines: c } = so(t, s, r), d = t.start && typeof t.start.column == "number", f = String(a).length, l = (n ? (0, dn.default)(e, r) : e).split(Cn, a).slice(D, a).map((F, m) => {
...
${l}`), n ? o.reset(l) : l;
      ...
      var ri = {};
      We(ri, { __debug: () => ti, check: () => Qo, doc: () => er, format: () => cu, formatWithCursor: () => au, getSupportInfo: () => ei, util: () => Qt, version: () => Du });
      var Cu = (e, t, r, n) => {
        if (!(e && t == null))
          return t.replaceAll ? t.replaceAll(r, n) : r.global ? t.replace(r, n) : t.split(r).join(n);
      }, ee = Cu;
      var Kn = he(ir(), 1);
      var M = "string", j = "array", W = "cursor", T = "indent", S = "align", v = "trim", _ = "group", w = "fill", x = "if-break", P = "indent-if-break", L = "line-suffix", I = "line-suffix-boundary", A = "line", O = "label", k = "break-parent", Ue = /* @__PURE__ */ new Set([W, T, S, v, _, w, x, P, L, I, A, O, k]);
      function _u(e) {
        if (typeof e == "string")
          return M;
        if (Array.isArray(e))
...
Expected it to be ${n}.`;
      ...
      var dr = { type: I }, le = { type: k }, mr = { type: v }, _e = { type: A, hard: true }, Bt = { type: A, hard: true, literal: true }, Ke = { type: A }, Er = { type: A, soft: true }, G = [_e, le], He = [Bt, le], xe = { type: W };
      function we(e, t) {
        z(e), ze(t);
        let r = [];
...
`);
      ...
      function Tu(e) {
        if (e.type === _ && e.break || e.type === A && e.hard || e.type === k)
          return true;
      }
      function br(e) {
      ...
      function wr(e) {
        for (e = [...e]; e.length >= 2 && y(false, e, -2).type === A && y(false, e, -1).type === k; )
          e.length -= 2;
        if (e.length > 0) {
      ...
      function Tr(e, t = He) {
        return Ne(e, (r) => typeof r == "string" ? we(t, r.split(`
`)) : r);
      }
      function Lu(e) {
        if (e.type === A)
      ...
      function Ru(e, t, r) {
        return t === Number.NEGATIVE_INFINITY ? e.root || vr() : t < 0 ? xt(e, { type: "dedent" }, r) : t ? t.type === "root" ? { ...e, root: e } : xt(e, { type: typeof t == "string" ? "stringAlign" : "numberAlign", n: t }, r) : e;
      }
      function xt(e, t, r) {
      ...
      function fe(e, t) {
        let r = {}, n = t.printWidth, o = ke(t.endOfLine), u = 0, i = [{ ind: vr(), mode: R, doc: e }], s = [], D = false, a = [], c = 0;
        for (Or(e); i.length > 0; ) {
...
`, o) : l;
            ...
            case w: {
              ...
              m.splice(0, 2);
              let Q = { ind: f, mode: p, doc: Ge(m) }, tr = m[0];
              Qe({ ind: f, mode: K, doc: [E, C, tr] }, [], F, a.length > 0, r, true) ? i.push(Q, Z, g) : B ? i.push(Q, $, g) : i.push(Q, $, h);
              break;
            }
            case x:
            case P: {
            ...
            case A:
              switch (p) {
                ...
                case R:
                  ...
                  l.literal ? f.root ? (s.push(o, f.root.value), u = f.root.length) : (s.push(o), u = 0) : (u -= wt(s), s.push(o + f.value), u = f.length);
                  break;
              }
              break;
            case O:
      ...
      function J(e) {
        ...
        return e.type === x ? { ...e, breakContents: J(e.breakContents), flatContents: J(e.flatContents) } : e.type === _ ? { ...e, contents: J(e.contents), expandedStates: (t = e.expandedStates) == null ? void 0 : t.map(J) } : e.type === w ? { type: "fill", parts: e.parts.map(J) } : e.contents ? { ...e, contents: J(e.contents) } : e;
      }
      function Pr(e) {
        ...
        function n(u, i, s) {
          ...
          if (u.type === A) {
            let c = ((D = s == null ? void 0 : s[i + 1]) == null ? void 0 : D.type) === k;
      ...
      var Lr = { cursorOffset: { category: "Special", type: "int", default: -1, range: { start: -1, end: 1 / 0, step: 1 }, description: `Print (to stderr) where a cursor at the given position would move to after formatting.
...
in order for it to be formatted.`, cliCategory: "Other" }, tabWidth: { type: "int", category: "Global", default: 2, description: "Number of spaces per indentation level.", range: { start: 0, end: 1 / 0, step: 1 } }, useTabs: { category: "Global", type: "boolean", default: false, description: "Indent with tabs instead of spaces." }, embeddedLanguageFormatting: { category: "Global", type: "choice", default: "auto", description: "Control how Prettier formats quoted code embedded in the file.", choices: [{ value: "auto", description: "Format embedded code if Prettier can automatically identify it." }, { value: "off", description: "Never automatically format embedded code." }] } };
      function et({ plugins: e = [], showDeprecated: t = false } = {}) {
        let r = e.flatMap((o) => o.languages ?? []), n = [];
        for (let o of Vu(Object.assign({}, ...e.map(({ options: u }) => u), Lr)))
          !t && o.deprecated || (Array.isArray(o.choices) && (t || (o.choices = o.choices.filter((u) => !u.deprecated)), o.name === "parser" && (o.choices = [...o.choices, ...ju(o.choices, r, e)])), o.pluginDefaults = Object.fromEntries(e.filter((u) => {
            var i;
      ...
      function Wu(e, t) {
        let r = e.plugins.flatMap((o) => o.languages ?? []), n = Mu(r, t.language) ?? Ir(r, t.physicalFile) ?? Ir(r, t.file) ?? (t.physicalFile, void 0);
      ...
      var kt = he(Pe(), 1), Vr = (e, t, { descriptor: r }) => {
        let n = [`${kt.default.yellow(typeof e == "string" ? r.key(e) : r.pair(e))} is deprecated`];
        return t && n.push(`we now treat it as ${kt.default.blue(typeof t == "string" ? r.key(t) : r.pair(t))}`), n.join("; ") + ".";
      };
      var se = he(Pe(), 1);
      ...
      var $r = " ".repeat(2), Wr = (e, t, r) => {
        ...
        return n && u.push(Mr(e, t, n, r.descriptor)), o && u.push([Mr(e, t, o.title, r.descriptor)].concat(o.values.map((i) => Ur(i, r.loggerPrintWidth))).join(`
`)), zr(u, r.loggerPrintWidth);
      };
      function Mr(e, t, r, n) {
        return [`Invalid ${se.default.red(n.key(e))} value.`, `Expected ${se.default.blue(r)},`, `but received ${t === tt ? se.default.gray("nothing") : se.default.red(n.value(t))}.`].join(" ");
      }
      function Ur({ text: e, list: t }, r) {
        let n = [];
        return e && n.push(`- ${se.default.blue(e)}`), t && n.push([`- ${se.default.blue(t.title)}:`].concat(t.values.map((o) => Ur(o, r - $r.length).replace(/^|\n/g, `$&${$r}`))).join(`
`)), zr(n, r);
      }
      function zr(e, t) {
        if (e.length === 1)
...
`, 1)[0].length);
      ...
      function Ot(e, t) {
        ...
        let i, s, D, a, c = 0, d = 0;
        for (; c < n; )
          Gr[c] = e.charCodeAt(u + c), bt[c] = ++c;
        for (; d < o; )
          for (i = t.charCodeAt(u + d), D = d++, s = d, c = 0; c < n; c++)
            a = i === Gr[c] ? D : D + 1, D = bt[c], s = bt[c] = D > s ? a > s ? s + 1 : a : a > D ? D + 1 : a;
        return s;
      }
      var rt = (e, t, { descriptor: r, logger: n, schemas: o }) => {
        let u = [`Ignored unknown option ${Nt.default.yellow(r.pair({ key: e, value: t }))}.`], i = Object.keys(o).sort().find((s) => Ot(e, s) < 3);
      ...
      function zu(e, t) {
        ...
        for (let o of Uu)
          o in t && (n[o] = Gu(t[o], r, b.prototype[o].length));
        return n;
      }
      var b = class {
        static create(t) {
      ...
      function St(e) {
        if (typeof e == "string")
          return { text: e };
        let { text: t, list: r } = e;
        return Ku((t || r) !== void 0, "Unexpected `expected` result, there should be at least one field."), r ? { text: t, list: { title: r.title, values: r.values.map(St) } } : { text: t };
      }
      function vt(e, t) {
        return e === true ? true : e === false ? { value: t } : e;
      }
      function Pt(e, t, r = false) {
      ...
      var Dt = class extends b {
        constructor(t) {
          super(t), this._choices = Jr(t.choices.map((r) => r && typeof r == "object" ? r : { value: r }), "value");
        }
      ...
      var ct = class extends at {
        ...
        validate(t, r) {
          return r.normalizeValidateResult(super.validate(t, r), t) === true && Qr(t);
        }
      };
      ...
      var lt = class {
        constructor(t, r) {
          let { logger: n = console, loggerPrintWidth: o = 80, descriptor: u = rn, unknown: i = nn, invalid: s = un, deprecated: D = on, missing: a = () => false, required: c = () => false, preprocess: d = (p) => p, postprocess: f = () => pe } = r || {};
        ...
        _applyNormalization(t, r) {
          ...
          for (let i of o) {
            ...
            let a = ({ from: p, to: l }) => {
              ...
              let F = Pt(s.deprecated(p, this._utils), D, true);
              if (F !== false)
                if (F === true)
      ...
      var It;
      function qu(e, t, { logger: r = false, isCLI: n = false, passThrough: o = false, FlagSchema: u, descriptor: i } = {}) {
        if (n) {
          if (!u)
        ...
        }, D = Ju(t, { isCLI: n, FlagSchema: u }), a = new lt(D, { logger: r, unknown: s, descriptor: i }), c = r !== false;
      ...
      function Ju(e, { isCLI: t, FlagSchema: r }) {
        ...
        for (let o of e)
          n.push(Xu(o, { isCLI: t, optionInfos: e, FlagSchema: r })), o.alias && t && n.push(nt.create({ name: o.alias, sourceName: o.name }));
        return n;
      }
      function Xu(e, { isCLI: t, optionInfos: r, FlagSchema: n }) {
        ...
        return e.array ? ot.create({ ...t ? { preprocess: (D) => Array.isArray(D) ? D : [D] } : {}, ...s, valueSchema: i.create(u) }) : i.create({ ...u, ...s });
      }
      var sn = qu;
      function Rt(e, t) {
        if (!t)
        ...
        for (let n = e.length - 1; n >= 0; n--) {
          let o = e[n];
          if (o.parsers && Object.prototype.hasOwnProperty.call(o.parsers, t))
            return o;
        }
      ...
      function Dn(e, t) {
        ...
        for (let n = e.length - 1; n >= 0; n--) {
          let o = e[n];
          if (o.printers && Object.prototype.hasOwnProperty.call(o.printers, t))
            return o;
        }
      ...
      async function Zu(e, t = {}) {
        ...
        let n = et({ plugins: e.plugins, showDeprecated: true }).options, o = { ...cn, ...Object.fromEntries(n.filter((f) => f.default !== void 0).map((f) => [f.name, f.default])) }, u = Rt(r.plugins, r.parser), i = await Yt(u, r.parser);
      ...
      var re = Zu;
      var ln = /* @__PURE__ */ new Set(["tokens", "comments", "parent", "enclosingNode", "precedingNode", "followingNode"]), Qu = (e) => Object.keys(e).filter((t) => !ln.has(t));
      function eo(e) {
      ...
      function co(e, t) {
        let { loc: r } = e;
        if (r) {
          let n = (0, An.codeFrameColumns)(t, r, { highlightCode: true });
          throw e.message += `
` + n, e.codeFrame = n, e;
        }
        throw e;
      ...
      Ie = /* @__PURE__ */ new WeakSet(), $t = function(t) {
        let { stack: r } = this;
...
` || o === "\r" || o === "\u2028" || o === "\u2029")
      ...
      var wn = po;
      function* Wt(e, t) {
        let { getVisitorKeys: r, filter: n = () => true } = t, o = (u) => wn(u) && n(u);
        for (let u of r(e)) {
          let i = e[u];
          if (Array.isArray(i))
            for (let s of i)
      ...
      function X(e, t, r) {
        t.leading = false, t.trailing = false, r && (t.marker = r), Ut(e, t);
      }
      function ue(e, t) {
      ...
      function Et(e, t) {
        ...
        if (!n)
          return [];
        let s = ((r == null ? void 0 : r(e, t)) ?? [...Wt(e, { getVisitorKeys: H(o) })]).flatMap((D) => n(D) ? [D] : Et(D, t));
      ...
      function Nn(e, t) {
        let { comments: r } = e;
        if (delete e.comments, !Mt(r) || !t.printer.canAttachComment)
          return;
        let n = [], { locStart: o, locEnd: u, printer: { experimentalFeatures: { avoidAstMutation: i = false } = {}, handleComments: s = {} }, originalText: D } = t, { ownLine: a = Gt, endOfLine: c = Gt, remaining: d = Gt } = s, f = r.map((p, l) => ({ ...On(e, p, t), comment: p, text: D, options: t, ast: e, isLastComment: r.length - 1 === l }));
        for (let [p, l] of f.entries()) {
          ...
          let $;
          if (i ? $ = [l] : (F.enclosingNode = E, F.precedingNode = m, F.followingNode = C, $ = [F, g, h, B, Z]), Eo(g, h, f, p))
            ...
            if (m && C) {
              let Q = n.length;
              Q > 0 && n[Q - 1].followingNode !== C && bn(n, h), n.push(l);
            } else
              m ? ue(m, F) : C ? ne(C, F) : E ? X(E, F) : X(B, F);
        }
        if (bn(n, t), !i)
          for (let p of r)
      ...
      function go(e, t) {
        var c;
        let r = e.node, n = [Sn(e, t)], { printer: o, originalText: u, locStart: i, locEnd: s } = t;
      ...
      async function Bo(e, t, r, n) {
        let o = await re({ ...r, ...t, parentParser: r.parser, originalText: e }, { passThrough: true }), { ast: u } = await De(e, o), i = await n(u, o);
        return Xe(i);
      }
      function _o(e) {
        return () => {
      ...
      async function je(e, t) {
        ({ ast: e } = await Ht(e, t));
        let r = /* @__PURE__ */ new Map(), n = new Bn(e), o = In(t), u = /* @__PURE__ */ new Map();
        await Ln(n, s, t, je, u);
      ...
      function Yn(e, t, r, n, o) {
        ...
        return (D = i.hasPrettierIgnore) != null && D.call(i, e) ? s = Rn(e, t) : o.has(u) ? s = o.get(u) : s = i.print(e, t, r, n), u === t.cursorNode && (s = Ze(s, (a) => [xe, a, xe])), i.printComment && (!i.willPrintOwnComments || !i.willPrintOwnComments(e, t)) && (s = vn(e, s, t)), s;
      }
      async function Ht(e, t) {
        let r = e.comments ?? [];
        t[Symbol.for("comments")] = r, t[Symbol.for("tokens")] = e.tokens ?? [], t[Symbol.for("printedComments")] = /* @__PURE__ */ new Set(), Nn(e, t);
        let { printer: { preprocess: n } } = t;
        return e = n ? await n(e, t) : e, { ast: e, comments: r };
      }
      var wo = ({ parser: e }) => e === "json" || e === "json5" || e === "json-stringify";
      function ko(e, t) {
      ...
      function bo(e, t, { locStart: r, locEnd: n }) {
      ...
      var $n = /* @__PURE__ */ new Set(["JsonRoot", "ObjectExpression", "ArrayExpression", "StringLiteral", "NumericLiteral", "BooleanLiteral", "NullLiteral", "UnaryExpression", "TemplateLiteral"]), No = /* @__PURE__ */ new Set(["OperationDefinition", "FragmentDefinition", "VariableDefinition", "TypeExtensionDefinition", "ObjectTypeDefinition", "FieldDefinition", "DirectiveDefinition", "EnumTypeDefinition", "EnumValueDefinition", "InputValueDefinition", "InputObjectTypeDefinition", "SchemaDefinition", "OperationTypeDefinition", "InterfaceTypeDefinition", "UnionTypeDefinition", "ScalarTypeDefinition"]);
      function Vn(e, t, r) {
        if (!t)
          return false;
        switch (e.parser) {
      ...
      function Mn(e, t, r) {
        ...
        if (wo(t)) {
          ...
          ({ startNode: d, endNode: f } = bo(a, c, t));
      ...
      function To(e, t) {
        ...
        for (let D of kn(e, { getVisitorKeys: u, filter: i }))
          s = D;
        return s;
      }
      var Wn = To;
      ...
      async function qn(e, t, r = 0) {
        ...
        if (r > 0) {
          ...
          i.cursorNodeStart !== void 0 && (i.cursorNodeStart -= i.formatted.indexOf(D)), i.formatted = D + ke(t.endOfLine);
        }
...
`, o) + 1), D = n.slice(s, o).match(/^\s*/)[0], a = Fe(D, t.tabWidth), c = await qn(i, { ...t, rangeStart: 0, rangeEnd: Number.POSITIVE_INFINITY, cursorOffset: t.cursorOffset > o && t.cursorOffset <= u ? t.cursorOffset - o : -1, endOfLine: "lf" }, a), d = c.formatted.trimEnd(), { cursorOffset: f } = t;
        f > u ? f += d.length - i.length : c.cursorOffset >= 0 && (f = c.cursorOffset + o);
        let p = n.slice(0, o) + d + n.slice(u);
        if (t.endOfLine !== "lf") {
          let l = ke(t.endOfLine);
          f >= 0 && l === `\r
` && (f += _t(p.slice(0, f), `
`)), p = ee(false, p, `
`, l);
      ...
      function zn(e, t) {
        ...
        return r = Jt(e, r, -1), n = Jt(e, n, 0), o = Jt(e, o, e.length), { ...t, cursorOffset: r, rangeStart: n, rangeEnd: o };
      }
      function Jn(e, t) {
...
`);
      ...
      async function Xt(e, t) {
        ...
        let u;
        return o.rangeStart > 0 || o.rangeEnd < n.length ? u = await So(n, o) : (!o.requirePragma && o.insertPragma && o.printer.insertPragma && !await Gn(n, o) && (n = o.printer.insertPragma(n)), u = await qn(n, o)), r && (u.formatted = Hn + u.formatted, u.cursorOffset >= 0 && u.cursorOffset++), u;
      }
      ...
      async function Qn(e, t) {
        let r = Pr(e), { formatted: n } = await Xt(r, { ...t, parser: "__js_expression" });
        return n;
      }
      ...
      var Ee = Po;
      function Lo(e, t) {
        return t === false ? false : e.charAt(t) === "/" && e.charAt(t + 1) === "/" ? mt(e, t) : t;
      }
      var Ce = Lo;
      function Io(e, t) {
        let r = null, n = t;
...
`)
      ...
      var ei = ae(et, 0), ti = { parse: ae(Xn), formatAST: ae(Zn), formatDoc: ae(Qn), printToDoc: ae(eu), printDocToString: ae(tu) };
      return nr(ri);
    });
  }
});
