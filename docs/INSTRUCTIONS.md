...
Deze leertaak hoort bij sprint 18 Release candidate. Dit is een leertaak die je in een team uitvoert.

## Doel van deze opdracht

In semester 3 heb je veel geleerd over het inzetten van workflow, tools en frameworks om een passende oplossing voor een opdrachtgever te realiseren. Het resultaat is een web applicatie op basis van data uit een bestaande API of een zelf in te richten API. Deze laatste sprint neem je als team de tijd om de puntjes op de i te zetten en jullie beste werk te leveren. Je beste werk, niet alleen qua resultaat maar ook qua proces. Je zorgt ervoor dat het eindresultaat goed op te pakken is door een volgend team, aka [quality assurance](https://github.com/fdnd-task/release-candidate/blob/main/docs/quality-assurance.md). 
